...
let iσx = 3, iσy = 1
    ...
    plot(masses(model), Base.Fix1(unpolarized_intensity, model);
        iσx, iσy, xlab, ylab, title=model_name, aspect_ratio=1)
end
```
