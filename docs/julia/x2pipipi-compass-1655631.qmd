...
For every bin, the model includes about 170 decay chains (about 88 waves, symmetrized for two $\pi^+\pi^-$ pairs). The main paper describing details of the analysis is [INSPIRE-HEP 1655631](https://inspirehep.net/literature/1655631).
...
#| output: false
input = open(joinpath(@__DIR__, "..", "..", "models", "x2pipipi-compass-1655631.json")) do io
    JSON.parse(io)
end
