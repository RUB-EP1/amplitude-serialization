...
The status marks 🟢, 🟡, and 🔴 indicate absolute differences of $<10^{-12}$, $<10^{-2}$, and $\ge10^{-2}$, respectively. Failed evaluations are marked 🔴; the diagnostic column provides details.
