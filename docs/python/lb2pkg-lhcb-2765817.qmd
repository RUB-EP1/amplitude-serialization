...
Amplitude checksums are evaluated on final-state four-vectors from the `phase_space` domain. Lineshape checksums still use a scalar invariant.

The status marks 🟢, 🟡, and 🔴 indicate absolute differences of $<10^{-10}$, $<10^{-2}$, and $\ge10^{-2}$, respectively.
