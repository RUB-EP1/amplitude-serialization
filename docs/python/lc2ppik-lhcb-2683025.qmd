...
import pandas as pd
import sympy as sp
from ampform.dynamics import BreitWigner, ChannelArguments, MultichannelBreitWigner
...
expr = FormFactor(s, m1, m2, angular_momentum, d, normalize=False)
...
expr = BreitWigner(s, m0, gamma0, m1, m2, angular_momentum, d, numerator="unity")
Math(aslatex(unfold_definitions(expr)))
```
